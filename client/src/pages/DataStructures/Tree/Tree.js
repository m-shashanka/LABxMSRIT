...
export default function Tree() {
    return (
        <div className={styles.page}>
            ...
            <img className={styles.treeimg} src={img1} alt="tree" /><br />
            <h3>Tree Node</h3><br />
...
`}</textarea> <br />
            ...
            <img className={styles.treeimg} src={img3} alt="root" /><br />
            <h3>Edge</h3><br />
            ...
            <h2>Types of Trees in Data Structures</h2><br />
            <h3>General Tree</h3><br />
...
`}</p><br />
            <img className={styles.treeimg} src={img17} alt="avl-tree" /><br />
            <h2>Tree Traversal</h2><br />
